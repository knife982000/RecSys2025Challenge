...
model.load_state_dict(torch.load('emb-8ShortVAECATURLFastNAdamWOneCycleLarge_best.pth'))
...
print(encode.shape)
os.makedirs('emb-8ShortVAECATURLFullNAOCLarAVG', exist_ok=True)
np.save('emb-8ShortVAECATURLFullNAOCLarAVG/client_ids.npy', clients)
np.save('emb-8ShortVAECATURLFullNAOCLarAVG/embeddings.npy', encode.astype(np.float16))